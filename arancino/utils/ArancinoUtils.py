...
class ArancinoConfig:
    ...
    def __init__(self):
        ...
        self.__redis_volatile_datastore_scr_db = int(self.Config.get("redis.volatile", "datastore_scr_db"))
        ...
        self.__redis_persistent_datastore_scr_db = int(self.Config.get("redis.persistent", "datastore_scr_db"))
        ...
        self.__redis_volatile_persistent_datastore_scr_db = int(self.Config.get("redis.volatile_persistent", "datastore_scr_db"))
        # endregion
    ...
    def get_redis_instances_conf(self):
        ...
        if redis_instance == RedisInstancesType.VOLATILE:
            ...
            dts_scr_db = self.__redis_volatile_datastore_scr_db
            ...
            dts_scr_db = self.__redis_persistent_datastore_scr_db
            ...
            dts_scr_db = self.__redis_volatile_persistent_datastore_scr_db
        ...
        redis_dts_scr = {'host': host_per, 'port': port_per, 'dcd_resp': dec_rsp, 'db': dts_scr_db}

        return redis_dts_std, redis_dts_dev, redis_dts_per, redis_dts_rsvd, redis_dts_tse, redis_dts_tag, redis_dts_scr
